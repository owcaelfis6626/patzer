// PeSTO evaluation tables — machine-extracted from chessprogramming.org (Ronald Friederich, rofChade).
// Layout: index 0 = a8 (visual board top-left), as in the original C. For a white piece on
// LERF square s use table[s ^ 56]; for black use table[s]. Extraction gate: 12x64 counts +
// piece-value spot-check passed at generation time.
